...
[![octonion](https://github.com/user-attachments/assets/c91dc9a3-4a8a-4a9f-84fe-2955b13aeca9)](https://en.wikipedia.org/wiki/Octonion)
...
[![Polarity](https://github.com/user-attachments/assets/ff85415c-e75f-4717-bf5f-19b73405e8d8)](https://mathoverflow.net/a/133091)

Octonions have applications in fields such as [string theory](https://en.wikipedia.org/wiki/String_theory), [special relativity](https://en.wikipedia.org/wiki/Special_relativity) and [quantum logic](https://en.wikipedia.org/wiki/Quantum_logic).

## Supersymmetric Multiplet

Further reflection shows that 'chirality' is essentially the same issue as 'right hand system' versus 'left hand system' in coordinate systems.

[![octonion](https://github.com/user-attachments/assets/ea2cc019-f0a0-4de0-8a9b-8b4369e73ab6)](https://math.ucr.edu/home/baez/octonions/node4.html)
...
[![MEC30 Square](https://user-images.githubusercontent.com/36441664/262213707-63aa0a64-cf7d-4fb7-9f1a-f3d1ba805643.png)](https://eq19.github.io/multiplication/)
...
We continue our study and classification of structures on the Fano plane F and its dual F involved in the construction of octonions and the Lie algebra g2(F) over a field F
